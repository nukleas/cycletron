...
//! real strudel-rs evaluator. Run: `cargo run -p cycletron-gen --example grid_demo`.

use cycletron_gen::grid::Grid;
use cycletron_gen::melody::{self, Dir};
use cycletron_gen::mini::Mini;
use cycletron_gen::scale::Scale;
use cycletron_gen::verify::{verify_grid, verify_notes};
