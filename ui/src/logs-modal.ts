...
class LogsModal {
    ...
    private async clear(): Promise<void> {
        ...
        try {
            ...
            if (this.content) this.content.textContent = `Could not clear logs: ${e}`;
        }
    }
    ...
    private async copyDump(): Promise<void> {
        ...
        try {
            ...
            if (this.copyBtn) {
                ...
                setTimeout(() => { if (this.copyBtn) this.copyBtn.textContent = original; }, 1500);
            }
        }
    }
}
