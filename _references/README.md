...
| [03-pattern-generation-primitives.md](03-pattern-generation-primitives.md) | Algorithmic-composition function inventories (total-serialism, isobar, Mercury) mapped to Cycletron's corpus categories + DSL gaps. |
...
| [05-recommendations.md](05-recommendations.md) | Actionable, prioritized opportunities for Cycletron pulled from all of the above. |
| [06-sounds-and-samples.md](06-sounds-and-samples.md) | How Strudel handles instruments/samples vs. cycletron today; desktop-power opportunities (soundfonts, bundled libs, user folders, native decode). |
...
1. **Pattern-generation primitives are the biggest win.** `total-serialism` and `isobar`
   ...
   choice, brownian walk…). Many map directly onto Cycletron's 6 corpus categories and
