...
stack(
  s("bd ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~, ~ ~ ~ ~ ~ ~ ~ ~ sd ~ ~ ~ ~ ~ ~ ~, hh ~ hh ~ hh ~ hh ~ hh ~ hh ~ hh ~ hh ~, ~ ~ ~ ~ ~ ~ ~ hh*3 ~ ~ ~ ~ ~ ~ ~ hh*4").gain(0.59).every(4, x => x.fast(2)),
  note("d1 ~ ~ ~ ~ ~ ~ ~ ~ ~ d1 ~ ~ ~ ~ ~").s("sine").attack(0.02).release(0.6).gain(0.36),
  note("<[d3, f#3, a3, c#4] [a3, c#4, e4, g4] [b3, d4, f#4, a4] [g3, b3, d4, f#4]>").s("supersaw").struct("~ 1 1 ~").release(0.25).lpf(2600).gain(0.25).room(0.45).pan(0.42),
  note("<[d5 ~ g5 ~ b5 ~ a5 ~] [d5 ~ g5 ~ b5 ~ a5 ~] [f#5 ~ b5 ~ d6 ~ c#6 ~] [a5 ~ a5 ~ b5 ~ f#5 ~]>").s("wt_lead").delay(0.3).room(0.4).gain(0.21).pan(0.62)
)
```
