...
stack(
  s("bd ~ ~ ~ bd ~ ~ ~ bd ~ ~ ~ bd ~ ~ ~, ~ ~ ~ ~ cp ~ ~ ~ ~ ~ ~ ~ cp ~ ~ ~, hh ~ hh ~ hh ~ hh ~ hh ~ hh ~ hh ~ hh ~").gain(0.46).every(4, x => x.fast(2)),
  note("a2 ~ a3 ~ a2 ~ a3 ~").s("sawtooth").lpf(800).resonance(7).gain(0.25),
  note("<[a3, c4, e4, g4] [f4, a4, c5, e5] [g4, b4, d5, f5] [e4, g4, b4, d5]>").s("supersaw").struct("~ 1 ~ 1").release(0.2).lpf(2200).gain(0.17).room(0.35).pan(0.42),
  note("a4 c5 e5 c5").s("wt_lead").delay(0.3).room(0.35).gain(0.16).pan(0.62)
)
```
