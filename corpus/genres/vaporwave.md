...
stack(
  s("bd ~ ~ ~ ~ ~ bd ~ ~ ~ bd ~ ~ ~ ~ ~, ~ ~ ~ ~ sd ~ ~ ~ ~ ~ ~ ~ sd ~ ~ ~").gain(0.72).crush(9).room(0.5).every(4, x => x.fast(2)),
  note("c2 ~ g2 ~ c2 ~ b2 ~").s("gm_acoustic_bass").gain(0.49),
  note("<[c3, e3, g3, b3] [f3, a3, c4, e4] [a3, c4, e4, g4] [g3, b3, d4, f4]>").s("gm_epiano1").release(0.8).gain(0.36).room(0.75).delay(0.4).pan(0.42),
  note("<[g4 ~ c5 ~ f5 ~ e5 ~] [g4 ~ c5 ~ f5 ~ e5 ~] [b4 ~ e5 ~ a5 ~ g5 ~] [e5 ~ e5 ~ e5 ~ b4 ~]>").s("wt_choir").attack(0.3).room(0.7).delay(0.4).gain(0.23).pan(0.62)
)
```
