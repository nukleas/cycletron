...
stack(
  s("~ ~ ~ lt ~ ~ lt ~ ~ ~ lt ~ ~ ~ lt ~, hh ~ hh ~ hh ~ hh ~ hh ~ hh ~ hh ~ hh ~, ~ ~ ~ ~ cp ~ ~ ~ ~ ~ ~ ~ cp ~ ~ ~").gain(0.8).every(4, x => x.fast(2)),
  note("f#1 ~ ~ ~ ~ ~ ~ ~ ~ ~ f#1 ~ ~ ~ ~ ~").s("sine").attack(0.03).release(0.6).gain(0.46),
  note("<[f#3, a3, c#4, e4] [b3, d4, f#4, a4] [c#4, e4, g#4, b4] [b3, d4, f#4, a4]>").s("gm_epiano1").release(0.5).gain(0.34).room(0.45).pan(0.42),
  note("<[f#5 ~ ~ c#6 ~ ~ b5 ~] [f#5 ~ ~ c#6 ~ ~ b5 ~] [a5 ~ ~ e6 ~ ~ d6 ~] [b5 ~ ~ c#6 ~ ~ a5 ~]>").s("wt_pluck").delay(0.3).room(0.4).gain(0.27).pan(0.62)
)
```
