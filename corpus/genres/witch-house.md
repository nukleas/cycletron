...
stack(
  s("bd ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~, ~ ~ ~ ~ ~ ~ ~ ~ sd ~ ~ ~ ~ ~ ~ ~, hh ~ hh ~ hh ~ hh ~ hh ~ hh ~ hh ~ hh ~").gain(0.69).crush(9).every(4, x => x.fast(2)),
  note("e1 ~ ~ ~ ~ ~ ~ ~ ~ ~ e1 ~ ~ ~ ~ ~").s("sine").attack(0.03).release(0.9).gain(0.43),
  note("<[e3, g3, b3, d4] [f3, a3, c4, e4] [e3, g3, b3, d4] [a3, c4, e4, g4]>").s("wt_choir").attack(1).release(2.5).lpf(900).gain(0.24).room(0.8).pan(0.42),
  note("<[e4 ~ ~ a4 ~ ~ g4 ~] [e4 ~ ~ a4 ~ ~ g4 ~] [g4 ~ ~ c5 ~ ~ b4 ~] [g4 ~ ~ a4 ~ ~ g4 ~]>").s("wt_bell").room(0.7).delay(0.45).gain(0.2).pan(0.62)
)
```
