...
stack(
  s("bd ~ ~ ~ bd ~ ~ ~ bd ~ ~ ~ bd ~ ~ ~, ~ ~ ~ ~ cp ~ ~ ~ ~ ~ ~ ~ cp ~ ~ ~, hh ~ hh ~ hh ~ hh ~ hh ~ hh ~ hh ~ hh ~").gain(0.47).crush(7).every(4, x => x.fast(2)),
  note("e2 ~ e3 ~ e2 ~ e3 ~").s("square").release(0.15).gain(0.24).crush(8),
  note("<[e3, g#3, b3, d#4] [b3, d#4, f#4, a4] [c#4, e4, g#4, b4] [a3, c#4, e4, g#4]>").s("pulse").struct("~ 1 ~ 1").release(0.18).gain(0.17).crush(8).pan(0.42),
  note("<[e6 ~ a6 ~ c#7 ~ b6 ~] [e6 ~ a6 ~ c#7 ~ b6 ~] [g#6 ~ c#7 ~ e7 ~ d#7 ~] [b6 ~ b6 ~ c#7 ~ g#6 ~]>").s("square").release(0.15).delay(0.2).gain(0.16).crush(8).pan(0.62)
)
```
