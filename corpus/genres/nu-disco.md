...
stack(
  s("bd ~ ~ ~ bd ~ ~ ~ bd ~ ~ ~ bd ~ ~ ~, ~ ~ oh ~ ~ ~ oh ~ ~ ~ oh ~ ~ ~ oh ~, ~ ~ ~ ~ cp ~ ~ ~ ~ ~ ~ ~ cp ~ ~ ~").gain(0.49).every(4, x => x.fast(2)),
  note("c2 ~ c3 ~ c2 ~ c3 ~").s("sawtooth").lpf(850).resonance(6).gain(0.27),
  note("<[c3, d#3, g3, a#3] [f3, a3, c4, d#4] [g3, a#3, d4, f4] [f3, a3, c4, d#4]>").s("gm_epiano1").struct("~ 1 ~ 1").release(0.2).gain(0.22).room(0.3).pan(0.42),
  note("<[c5 ~ f5 ~ g5 ~ f5 ~] [c5 ~ f5 ~ g5 ~ f5 ~] [d#5 ~ a5 ~ a#5 ~ a5 ~] [f5 ~ f5 ~ g5 ~ d#5 ~]>").s("wt_pluck").delay(0.25).room(0.3).gain(0.16).pan(0.62)
)
```
