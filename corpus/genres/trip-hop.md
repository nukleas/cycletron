...
stack(
  s("bd ~ ~ ~ ~ ~ bd ~ ~ ~ bd ~ ~ ~ ~ ~, ~ ~ ~ ~ sd ~ ~ ~ ~ ~ ~ ~ sd ~ ~ ~, hh ~ ~ ~ hh ~ ~ ~ hh ~ ~ ~ hh ~ ~ ~").gain(0.63).crush(9).every(4, x => x.fast(2)),
  s("~ ~ hh ~ ~ ~ hh ~ ~ ~ hh ~ ~ ~ hh ~").late(0.0219).gain(0.63).crush(9),
  note("c#1 ~ ~ ~ ~ ~ ~ ~ ~ ~ c#1 ~ ~ ~ ~ ~").s("sine").attack(0.02).release(0.6).gain(0.41),
  note("<[c#3, e3, g#3, b3] [a3, c#4, e4, g#4] [f#3, a3, c#4, e4] [a3, c#4, e4, g#4]>").s("gm_epiano1").release(0.5).gain(0.28).room(0.45).pan(0.42),
  note("<[g#4 ~ c#5 ~ f#5 ~ e5 ~] [g#4 ~ c#5 ~ f#5 ~ e5 ~] [b4 ~ e5 ~ a5 ~ g#5 ~] [e5 ~ e5 ~ e5 ~ b4 ~]>").s("wt_flute").room(0.4).delay(0.3).gain(0.21).pan(0.62)
)
```
