...
stack(
  s("bd ~ ~ ~ ~ ~ bd ~ ~ ~ bd ~ ~ ~ ~ ~, ~ ~ ~ ~ sd ~ ~ ~ ~ ~ ~ ~ sd ~ ~ ~, mt ~ ~ ~ ~ mt ~ ~ ~ ~ mt ~ ~ ~ ~ ~").gain(0.59).every(4, x => x.fast(2)),
  note("g2 ~ d3 ~ g2 ~ f#3 ~").s("gm_acoustic_bass").gain(0.41),
  note("<[g3, b3, d4, f#4] [d4, f#4, a4, c5] [e4, g4, b4, d5] [c4, e4, g4, b4]>").s("wt_piano").release(0.5).gain(0.28).room(0.4).pan(0.42),
  note("<[d5 ~ g5 ~ c6 ~ b5 ~] [d5 ~ g5 ~ c6 ~ b5 ~] [f#5 ~ b5 ~ e6 ~ d6 ~] [b5 ~ b5 ~ b5 ~ f#5 ~]>").s("gm_kalimba").room(0.4).delay(0.25).gain(0.24).pan(0.62)
)
```
