...
stack(
  s("bd ~ ~ ~ bd ~ ~ ~ bd ~ ~ ~ bd ~ ~ ~, ~ ~ oh ~ ~ ~ oh ~ ~ ~ oh ~ ~ ~ oh ~, hh ~ hh ~ hh ~ hh ~ hh ~ hh ~ hh ~ hh ~").gain(0.88).every(4, x => x.fast(2)),
  note("~ e2 ~ e2 ~ e2 ~ e3").s("sawtooth").lpf(650).resonance(5).gain(0.47),
  note("<[e3, g3, b3, d4] [c4, e4, g4, b4] [d4, f#4, a4, c5] [c4, e4, g4, b4]>").s("wt_pad").attack(1).release(2).lpf(1400).gain(0.31).room(0.6).pan(0.42),
  note("e4 g4 b4 e5 g5 b5").s("wt_pluck").delay(0.4).room(0.4).gain(0.29).pan(0.62)
)
```
