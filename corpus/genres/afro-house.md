...
stack(
  s("bd ~ ~ ~ bd ~ ~ ~ bd ~ ~ ~ bd ~ ~ ~, mt ~ ~ mt ~ ~ mt ~ ~ mt ~ ~ mt ~ ~ ~, ~ hh ~ hh ~ hh ~ hh ~ hh ~ hh ~ hh ~ hh").gain(0.73).every(4, x => x.fast(2)),
  note("~ a2 ~ a2 ~ a2 ~ a3").s("sawtooth").lpf(700).resonance(6).gain(0.41),
  note("<[a3, c4, e4, g4] [d4, f#4, a4, c5]>").s("gm_epiano1").struct("~ 1 ~ ~").release(0.3).gain(0.29).room(0.35).pan(0.42),
  note("<[a5 ~ d6 ~ e6 ~ d6 ~] [a5 ~ d6 ~ e6 ~ d6 ~] [c6 ~ f#6 ~ g6 ~ f#6 ~] [d6 ~ d6 ~ e6 ~ c6 ~]>").s("gm_kalimba").delay(0.25).room(0.35).gain(0.26).pan(0.62)
)
```
